...
module Cash
  ...
  class TransactionCreator
    Input = Struct.new(
      ...
      # Returns nil for blank input - caller passes it through and lets model
      # validation surface a presence error. ArgumentError from BigDecimal
      # collapses to nil for the same reason.

...
module Mcp
  module Tools
    module BankAccounts
      class RefreshBalances < Mcp::ApplicationTool
        tool_name "bank_accounts.refresh_balances"
        description "Pull fresh balances from the AISP provider. Live API call."
        ...
        def self.call(server_context:, **args)
          ...
          text("Balances refreshed for ##{account.id}.")

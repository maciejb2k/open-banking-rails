...
class Merchant < ApplicationRecord
  # `default_category` flows through to every transaction enriched against
  # this merchant (unless the tx has its own override). Changing the default
  # retroactively re-categorizes all matching transactions.

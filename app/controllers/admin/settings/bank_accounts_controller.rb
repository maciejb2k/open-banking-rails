  ...
  module Settings
    class BankAccountsController < BaseController
      ...
      def refresh_details
        ...
        redirect_to admin_settings_bank_account_path(@account), notice: "Account details refreshed."
      rescue EnableBanking::Operations::RefreshAccountDetails::Failed => e
        redirect_to admin_settings_bank_account_path(@account), alert: "Refresh failed: #{e.message}"
      end

      def refresh_balances
        EnableBanking::Operations::RefreshAccountBalances.call(@account)
        redirect_to admin_settings_bank_account_path(@account), notice: "Balances refreshed."

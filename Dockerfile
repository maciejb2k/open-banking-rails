...
# docker build -t open_banking_rails .
# docker run -d -p 80:3000 -e RAILS_MASTER_KEY=<value from config/master.key> --name open_banking_rails open_banking_rails
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl libjemalloc2 libvips postgresql-client nano vim-tiny && \
